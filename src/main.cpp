...
uint256 hashGenesisBlock("0x21a079b35e3518a22f7d718d19745615c9c764346d707f6fa97a23c97af17da0");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 42048000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 42048000); // Goldencoin: 42.048m blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Goldencoin: 1 day
static const int64 nTargetSpacing = .05 * 60; // Goldencoin: 3 Seconds
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf8eac62ba41beb82ff48dbaffdb434abe2a1284bda2b7fa143948296f56a0a93");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Forkast.News 07/20/2021 U.S. senators ask athletes to boycott digital yuan at Beijing Winter Olympics";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = .12 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04a4a1a9cf2b6c74dd9fefd1f3fcc7c15d0bf1abffbae800b529d61f78c6a93a39e98be63705ba5e937624f3ec6e3ae06bb116c0170e6faaa8e6816e267303f370") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1626825122;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084741000;

        if (fTestNet)
        {
            block.nTime    = 1626825121;
            block.nNonce   = 385847583;
        }
...
if (true && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x0b2b612896957b919e2c376bb83959895abf06638bf3b12ad107c2d07661ca86"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf3, 0xb2, 0xb4, 0xd1 }; // Goldencoin: increase each by adding 2 to bitcoin's value.

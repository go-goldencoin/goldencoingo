...
This folder describe how to CPU mine Goldencoin (GDNC) on 32 bits android phone (armhf). 
...
```
The above step automatically download binary GDNC wallet file and cheetah_cpuminer in current folder.

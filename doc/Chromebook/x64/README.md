...
This folder describe how to run a full node of Goldencoin (GDNC) and to CPU mine GDNC in Chromebook as Linux App.  Chrome OS v85 on x64 platform was tested. 
...
Go to Chrome OS setting, turn on Linux (Beta).  If your chromebook does not have this option, it is not supported here for GDNC CPU mining. 
...
```
 ...
 Then restart the QT GUI wallet, GDNC should start to sync. Note fully synced to latest block is required in order to CPU mining GDNC with Cheetah_Cpuminer

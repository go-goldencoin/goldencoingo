...
VAR1="/home/pi/Debian_10/arm64/goldencoin_v1.7.0.2_u16_arm64/goldencoind"
...
#VAR1="/home/note9s/Android_Userland_App/ubuntu/arm64/goldencoin_v1.7.0.2_u16_arm64/goldencoind"
...
# as ../../../cheetahcoind getbalance or ../../../goldencoind getbalance
Min_Bal="0.00000000"
...
GDNC_Reserve="NM6F3w2Dmbccx44xUQ3e3d63MWtk1eMWDk"
...
GDNC_Var_Bal=$(get_neng_balance)
CHTA_Var_Bal=$(get_chta_balance)

function Tx_2_GDNC_Reserve(){
        $VAR1 sendtoaddress $GDNC_Reserve $GDNC_Var_Bal
}
...
## Send to reserve
if [ $GDNC_Var_Bal == $Min_Bal ]
then
        echo "Local GDNC Balance = " $GDNC_Var_Bal
        echo "Value is Zero, therefore nothing to do."
else
        echo "GDNC Balance is not Zero = " $GDNC_Var_Bal
        echo "Sending balance to reserve wallet."
        Tx_2_GDNC_Reserve
        echo "Done"
        echo "Local GDNC Wallet New Balance: "
        get_neng_balance
fi
